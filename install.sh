...
# Stalwart Server install script -- based on the rustup installation script.
...
main() {
    ...
    if [ "$_component" = "stalwart-mail-foundationdb" ]; then
        ignore mv "$_dir/bin/stalwart-mail-foundationdb" "$_dir/bin/stalwart"
    fi
