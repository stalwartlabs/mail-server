...
impl EventType {
    pub fn code(&self) -> u64 {
        match self {
            ...
            EventType::Spam(SpamEvent::RemoteList) => 492,
            EventType::Spam(SpamEvent::RemoteListError) => 493,
    ...
    pub fn from_code(code: u64) -> Option<Self> {
        match code {
            ...
            492 => Some(EventType::Spam(SpamEvent::RemoteList)),
            493 => Some(EventType::Spam(SpamEvent::RemoteListError)),
